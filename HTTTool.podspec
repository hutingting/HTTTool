#
#  Be sure to run `pod spec lint HTTTool.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "hutingting" => "914774202@qq.com" }
  # Or just: s.author    = "hutingting"
  # s.authors            = { "hutingting" => "914774202@qq.com" }
  # s.social_media_url   = "http://twitter.com/hutingting"
...
s.source       = { :git => "https://github.com/hutingting/HTTTool.git", :tag => s.version }
